...
{
	public struct SNUInt64 : IComparable, IComparable<ulong>, IComparable<SNUInt64>, IFormattable, IEquatable<ulong>, IEquatable<SNUInt64>, IConvertible
	{
		Encryptor encryptor;
		ulong encryptedValue;

		public SNUInt64(ulong value)
		{
		...
		public int CompareTo(SNUInt64 value)
		{
		...
		public bool Equals(SNUInt64 value)
		{
