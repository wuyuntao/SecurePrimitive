...
{
	public struct SNInt32 : IComparable, IComparable<int>, IComparable<SNInt32>, IFormattable, IEquatable<int>, IEquatable<SNInt32>, IConvertible
	{
		Encryptor encryptor;
		int encryptedValue;

		public SNInt32(int value)
		{
		...
		public int CompareTo(SNInt32 value)
		{
		...
		public bool Equals(SNInt32 value)
		{
