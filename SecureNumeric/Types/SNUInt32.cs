...
{
	public struct SNUInt32 : IComparable, IComparable<uint>, IComparable<SNUInt32>, IFormattable, IEquatable<uint>, IEquatable<SNUInt32>, IConvertible
	{
		Encryptor encryptor;
		uint encryptedValue;

		public SNUInt32(uint value)
		{
		...
		public int CompareTo(SNUInt32 value)
		{
		...
		public bool Equals(SNUInt32 value)
		{
